...
//Purpose of the program: Uses a vector stack to make an integer postfix expression 
//                        calculator that can add, subtract, and muliply.
...
//           the stack and poping them when there is a operator. It pops the result
//           and displays it. Then checks for incomplete expressions.
int main()
{
  stack postfixstack;  // integer vector stack
  string expression, close;   // user entered expression
